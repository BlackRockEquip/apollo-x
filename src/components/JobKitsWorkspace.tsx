  ...
  return <div>
    ...
    <section className="master-panel">
      <div className="master-toolbar">
        ...
        <button type="button" className="gold-button" onClick={() => { setSelectedKit(null); setForm({ name: "", description: "", machineMake: "", machineModel: "", componentType: "", active: true, partId: "", quantityDefault: "1", notes: "", sortOrder: "0" }); }}><Plus size={15} /> New job kit</button>
      </div>
